...
from mtg_sorter_reflex.MTG_Sorter.ocr_engine import OCREngine
# Load the local database
db_path = Path("/Users/mdub/Documents/MTG_Sorter/mtg_sorter_reflex/oracle_cards.json")
...
def lookup_card_locally(ocr_name):
    ...
    # Normalize the OCR output (placeholder for string normalization)
    normalized_name = ocr_name.strip().lower()
...
def process_inventory(image_root):
    ...
    for image_path in image_paths:
        ...
        card_name, collect_name = ocr_engine_instance.extract_name(image_path)
